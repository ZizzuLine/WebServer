        ...
        <div class="container-fluid bg-dark py-2 d-none d-md-flex">
            <div class="container">
                <div class="d-flex justify-content-between topbar">
                    ...
                    <!--<div id="note" class="text-secondary d-none d-xl-flex"><small>Per qualsiasi domanda, sentiti libero di chiedere sul forum di Hacklab.</small></div>-->
                    <div class="top-link">
            ...
            <div class="container pt-5">
                <div class="row g-5">
                    ...
                    <div class="col-lg-7 col-md-6 col-sm-12 wow fadeIn" data-wow-delay=".5s">
                        ...
                        <a href="" class="btn btn-secondary rounded-pill px-5 py-3 text-white">Più dettagli</a>
                    </div>
                </div>
            </div>
        </div>
